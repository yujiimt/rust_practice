...
pub fn draw_mandelbrot_set(){
    ...
    let canvas: web_sys::HtmlCanvasElement = canvas
        .dyn_int::<web_sys::HtmlCanvasElement>()
        .map_err(|_| ())
        .unwrap();
    let context = canvas
        .get_context("2d")
    ...
    let mut result = measure_elapsed_time!("generate:wsam\telapsed:", {
        logic::test_generate_mandelbrot_set(canvas_w, canvas_h,
            X_MIN, X_MAX, Y_MIN, Y_MAX, MAX_ITER
        )
    });
    measure_elapsed_time!("draw:wasm\tela@sed:", {
